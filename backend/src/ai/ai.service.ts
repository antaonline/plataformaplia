...
export class AiService {
  ...
  private get env() {
    return {
      ...
      modelPrimary: process.env.OPENAI_MODEL_PRIMARY || 'gpt-4.1',
      modelPrimaryEconomy: process.env.OPENAI_MODEL_PRIMARY_ECONOMY || 'gpt-4.1-mini',
      modelCopy: process.env.OPENAI_MODEL_COPY || 'gpt-4o',
      modelCopyEconomy: process.env.OPENAI_MODEL_COPY_ECONOMY || 'gpt-4.1-mini',
