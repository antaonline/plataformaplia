                ...
                <div className="space-y-8 text-muted-foreground">
                  ...
                  <section>
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-4">
                      <li>Yape (Próximamente)</li>
                      <li>Plin (Próximamente)</li>
                  ...
                  <section>
                    ...
                    <p>
                      ...
                      de autor, pornográfico, o que promueva actividades ilegales. De hacerse o publicarse contenido de esta índole, PLIA tiene el derecho de eliminar dicho sitio web y/o contenido sin derecho a reclamo.
                    </p>
                  </section>
